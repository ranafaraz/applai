...
class OpportunityImportController extends Controller
{
    ...
    public function template(): Response
    {
        ...
        $rows = [
            ['title', 'type', 'organization', 'description', 'url', 'status', 'priority', 'deadline', 'notes', 'contact_emails', 'draft_email', 'followup_email', 'draft_attachments', 'followup_attachments'],
            [
            ...
            [
                ...
                'https://example.com/files/case-study.pdf',
            ],
            [
