...
<div class="max-w-xl">
    ...
    <div class="bg-white border border-slate-200 rounded-xl p-6 space-y-5">
        <div class="bg-blue-50 border border-blue-200 rounded-lg px-4 py-3 text-sm text-blue-800">
            ...
            <p class="mt-2"><strong>Attachments:</strong> add <code class="font-mono bg-blue-100 px-1 rounded">draft_attachments</code> and/or <code class="font-mono bg-blue-100 px-1 rounded">followup_attachments</code> columns with a <code>;</code>-separated list of public <code>http(s)://</code> URLs. Files are downloaded (≤20 MB each, http/https only) and attached to the corresponding email. They also show up in your Documents library, linked to the contact + opportunity.</p>
        </div>
        <div>
